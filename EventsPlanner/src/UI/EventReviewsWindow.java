...
public class EventReviewsWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Reseñas de los eventos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventReviewsWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void generateTable(ResultSet r) throws SQLException
    {
        ...
        while(r.next())
        {
            model.addRow(new Object[]{r.getString(2), r.getString(3), r.getInt(4), r.getString(5)});
        } 
    }
    
    private void generateEventReviewsTable()
    {
        try {
           Class.forName("com.mysql.jdbc.Driver");
        } catch (ClassNotFoundException ex) {
           Logger.getLogger(EventReviewsWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
        final String DB_URL =
        ...
        try {
            ...
            CallableStatement stmt = con.prepareCall("{call getEventReviews(?)}");
