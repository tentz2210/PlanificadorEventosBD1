...
public class UserInvitationsWindow extends javax.swing.JFrame {

    /**
     * Creates new form citizenWindow
     */
    public UserInvitationsWindow() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setVisible(true);
        this.generateUserInvitationsTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Mis invitaciones");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserInvitationsWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserInvitationsWindow().setVisible(true);
            }
        });
    }
    ...
    private void generateTable(ResultSet r) throws SQLException
    {
        ...
        while(r.next())
        {
            java.sql.Date startDate = r.getDate(2);
            java.sql.Date endDate = r.getDate(3);
            DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
            String startDateStr = dateFormat.format(startDate);
            String endDateStr = dateFormat.format(endDate);
            model.addRow(new Object[]{r.getString(1), startDateStr, endDateStr, r.getString(4)});
        } 
    }
    
    private void generateUserInvitationsTable()
    {
        try {
           Class.forName("com.mysql.jdbc.Driver");
        } catch (ClassNotFoundException ex) {
           Logger.getLogger(UserInvitationsWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
        final String DB_URL =
        ...
        try {
            ...
            CallableStatement stmt = con.prepareCall("{call getInvitations(?,?)}");
            stmt.setInt(1, Global.person_id);
