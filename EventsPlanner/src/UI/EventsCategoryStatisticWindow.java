...
public class EventsCategoryStatisticWindow extends javax.swing.JFrame {

    /**
     * Creates new form citizenWindow
     */
    public EventsCategoryStatisticWindow() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Estadísticas de Evento por Categoría");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventsCategoryStatisticWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EventsCategoryStatisticWindow().setVisible(true);
            }
        });
    }
    ...
    private void generateEventCategoryChart()
    {
        final String DB_URL =
        ...
        try {
            ...
            CallableStatement stmt = con.prepareCall("{call getEventStatisticsPerCategory()}");
            r = stmt.executeQuery();
            generateChart(r);
        } catch (SQLException ex) {
            Logger.getLogger(EventsCategoryStatisticWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
