...
import Utils.*;
public class AssistedEventsWindow extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssistedEventsWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void generateTable(ResultSet r) throws SQLException
    {
        ...
        while(r.next())
        {
            model.addRow(new Object[]{r.getString(1), r.getInt(3), r.getString(4)});
        } 
    }
    
    private void generateAssistedEventsTable()
    {
        try {
           Class.forName("com.mysql.jdbc.Driver");
        } catch (ClassNotFoundException ex) {
           Logger.getLogger(AssistedEventsWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
        final String DB_URL =
        ...
        try {
            ...
            CallableStatement stmt = con.prepareCall("{call getAssistedEvents(?)}");
