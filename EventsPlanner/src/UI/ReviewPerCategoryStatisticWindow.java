...
public class ReviewPerCategoryStatisticWindow extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReviewPerCategoryStatisticWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void generateReviewCategoryChart()
    {
        final String DB_URL =
        ...
        try {
            ...
            CallableStatement stmt = con.prepareCall("{call getReviewsStatisticsPerCategory()}");
            r = stmt.executeQuery();
            generateChart(r);
        } catch (SQLException ex) {
            Logger.getLogger(ReviewPerCategoryStatisticWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
