...
public class PublicEventsWindow extends javax.swing.JFrame {

    /**
     * Creates new form citizenWindow
     */
    public PublicEventsWindow() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PublicEventsWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PublicEventsWindow().setVisible(true);
            }
        });
    }
    ...
    private void generateTable(ResultSet r) throws SQLException
    {
        ...
        while(r.next())
        {
            ...
            model.addRow(new Object[]{r.getString(1), startDateStr, endDateStr, r.getString(5),r.getString(6),r.getString(7)});
        } 
    }
    ...
    private void generateUserInvitationsTable()
    {
        try {
           ...
           Logger.getLogger(PublicEventsWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
        final String DB_URL =
        ...
        try {
            ...
            CallableStatement stmt = con.prepareCall("{call getPublicEvents(?)}");
