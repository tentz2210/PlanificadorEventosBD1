...
public class PeopleCategoryStatisticWindow extends javax.swing.JFrame {

    /**
     * Creates new form citizenWindow
     */
    public PeopleCategoryStatisticWindow() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Estadísticas de Persona por Categoría");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeopleCategoryStatisticWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PeopleCategoryStatisticWindow().setVisible(true);
            }
        });
    }
    ...
    private void generatePersonCategoryChart()
    {
        final String DB_URL =
        ...
        try {
            ...
            CallableStatement stmt = con.prepareCall("{call getPeopleStatisticsPerCategory()}");
            r = stmt.executeQuery();
            generateChart(r);
        } catch (SQLException ex) {
            Logger.getLogger(PeopleCategoryStatisticWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
