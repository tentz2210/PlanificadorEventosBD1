...
public class FinishedEventsWindow extends javax.swing.JFrame {

    /**
     * Creates new form citizenWindow
     */
    queriesWindow quW;
    public FinishedEventsWindow(queriesWindow qW) {
        initComponents();
        quW = qW;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Eventos finalizados");
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(115, 50, -1, 20));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.generateFinishedEventsTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinishedEventsWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void generateFinishedEventsTable()
    {
        try {
           Class.forName("com.mysql.jdbc.Driver");
        } catch (ClassNotFoundException ex) {
           Logger.getLogger(FinishedEventsWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
        final String DB_URL =
        ...
        try {
            ...
            CallableStatement stmt = con.prepareCall("{call getFinishedEvents(?,?)}");
